...
```json
{
  "morning": ["밥/잡곡밥", "깍두기", "소고기두부국", "떡갈비", "계란말이", "무말랭이지", "우유"],
  "lunch": ["짜장밥", "장국", "양배추샐러드", "꿔바로우탕수육", "김치", "농후발효유"],
  "dinner": ["밥/잡곡밥", "깍두기", "콩나물국", "훈제오리불고기", "부추생채", "메밀묵무침"]
}
```
...
[
  ...
  },
  {
    "title": "3층 스낵코너",
    "subtitle": "라면코너",
    "menus": ["계란라면", "치즈라면", "계란라면+공기밥", "치즈라면+공기밥", "부대찌개라면+공기밥"]
  },
  {
    "title": "3층 스낵코너",
    "subtitle": "분식코너",
